...
namespace IsaacSpider.Tests
{
    ...
    {
        private const string PREFAB_PATH = "Assets/unity_export/IsaacSpider/IsaacSpider.prefab";
        private const string URDF_PATH = "Assets/unity_export/IsaacSpider/robot/spider.urdf";
        private const string ONNX_PATH = "Assets/unity_export/IsaacSpider/spider.onnx";
        private const string REFERENCE_PATH = "Assets/unity_export/IsaacSpider/isaac_reference.json";
