...
namespace PoRacer.IsaacPorts
{
    ...
    /// classified as EditMode, where FixedUpdate never runs). No agent parses JSON at
    /// run time - each reads its own generated rig asset.
    ///
    /// This was two identical copies, one in IsaacH1 and one in MujocoBiped, until the
    /// ports were merged into a single assembly on 2026-08-29.
    ///
