...
namespace PoRacer.Tests
{
    ...
    public sealed class RewardNaNGuardTests
    {
        ...
        public void Step_NaNInputs_NeverReturnsNaN()
        {
            ...
            float reward = sut.Step(float.NaN, float.NaN, float.NaN);
        ...
        public void Step_InfinityInputs_NeverReturnsNaN()
        {
            ...
            float reward = sut.Step(float.PositiveInfinity, float.NegativeInfinity, float.PositiveInfinity);
        ...
        public void Reset_WithNaN_DoesNotPoisonNextStep()
        {
            ...
            float reward = sut.Step(10f, 0f, 0f);
        ...
        public void Step_AfterNaNRecovery_ResumesNormalRewards()
        {
            var sut = new Reward_WormLoco();
            sut.Reset(10f);
            sut.Step(float.NaN, 0f, 0f); // poisoned frame

            float reward = sut.Step(9.9f, 0f, 0f); // sane frame: 0.1 m approach
