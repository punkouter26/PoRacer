...
{
    /// <summary>
    /// Where the worm race keeps its assets. The runtime uses these in error messages that
    /// say exactly what to copy where; the editor race driver uses the scene path.
    /// </summary>
