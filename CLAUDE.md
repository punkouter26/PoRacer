...
> re-verified against the project on 2026-08-27.
...
- UnitySkills (`com.besty.unity-skills`, git), Input System 1.20.0, Test Framework 1.7.0

Removed as unused: AI Navigation, PrimeTween (and the OpenUPM scoped registry it
alone needed), Sentry, UGUI/TextMeshPro (the project is 100% UI Toolkit), plus 27
built-in modules. Visual Scripting was never installed. Splines and Timeline are
indirect dependencies of Cinemachine, not direct ones.

### Architecture

- Assembly definitions: `PoRacer.Runtime` (`Assets/Scripts/`), `PoRacer.Editor`
  (`Assets/Scripts/Editor/`), `PoRacer.Tests` (`Assets/Tests/`)
